  ...
  return (
    <Fragment>
      <Box component={"section"}
        sx={{
          position: "relative",
          background: `url(${Images.platskador_bg_img.src})no-repeat center`,
      ...
      >
        ...
        <Container maxWidth={"xl"} sx={{ height: "100%" }}>
          ...
          >
            <Typography variant="h2" sx={{ fontWeight: 700, fontSize: "50px", fontFamily: "Urbanist", color: Colors.white, textTransform: "uppercase" }}>plåtskador</Typography>
            <Typography variant="body1" sx={{ fontSize: "20px", fontFamily: "Urbanist", color: Colors.white }}>Hem  /  PLÅTSKADOR</Typography>
          </Box>
        </Container>
      </Box>
