  ...
  return (
    <Fragment>
      <Box component={"section"}
        sx={{
          position: "relative",
          background: `url(${Images.dackhotell_bg_img.src})no-repeat center`,
      ...
      >
        ...
        <Container maxWidth={"xl"} sx={{ height: "100%" }}>
          ...
          >
            <Typography variant="h2" sx={{ fontWeight: 700, fontSize: "50px", fontFamily: "Urbanist", color: Colors.white, textTransform: "uppercase" }}>däckhotell</Typography>
            <Typography variant="body1" sx={{ fontSize: "20px", fontFamily: "Urbanist", color: Colors.white }}>Hem  /  däckhotell</Typography>
          </Box>
        </Container>
      </Box>
